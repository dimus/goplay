			...
			expr: &actionExpr{
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&notExpr{
							pos: position{line: 12, col: 26, offset: 167},
							expr: &anyMatcher{
								line: 12, col: 27, offset: 168,
							},
						},
					},
				},
...
func (p *parser) callonSciName1() (interface{}, error) {
	...
	_ = stack
	return p.cur.onSciName1(stack["grp"])
}
...
func (p *parser) callonNameGroup1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
	return p.cur.onNameGroup1(stack["names"])
}

func (c *current) onName1(uni interface{}) (interface{}, error) {
...
func (p *parser) callonName1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
	return p.cur.onName1(stack["uni"])
}

func (c *current) onUninomial1() (interface{}, error) {
	return newUninomialNode(string(c.text))
}

func (p *parser) callonUninomial1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
	return p.cur.onUninomial1()
}

func (c *current) onCapWord1() (interface{}, error) {
	return c.text, nil
}

func (p *parser) callonCapWord1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
	return p.cur.onCapWord1()
}
...
func (c *current) onCapChar1() (interface{}, error) {
	return c.text, nil
}

func (p *parser) callonCapChar1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
	return p.cur.onCapChar1()
}

func (c *current) onChar1() (interface{}, error) {
	return c.text, nil
}

func (p *parser) callonChar1() (interface{}, error) {
	stack := p.vstack[len(p.vstack)-1]
	_ = stack
